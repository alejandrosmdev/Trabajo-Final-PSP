        ...
        new Thread(() -> {
            try {
                while (true) {
                    ...
                    System.out.println("Zángano: buscando reina durante " + searchTime/1000.0 + " seg");
                    ...
                    if(new java.util.Random().nextInt(10) == 0) {
                        ...
                        System.out.println("Zángano: no encontré reina. Solicitando alimento.");
                        sendMessage("REQUEST_FOOD");
                        String msg = readMessage();
                        if(msg != null && msg.startsWith("FOOD_PROVIDED")) {
                            System.out.println("Zángano: recibí alimento. Reiniciando búsqueda.");
                        }
                    }
                }
            } catch(Exception e) {
