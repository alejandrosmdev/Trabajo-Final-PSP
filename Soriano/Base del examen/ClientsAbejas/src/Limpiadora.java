...
public class Limpiadora extends Thread {
    private static final String host_limpiadora = "localhost";
    private static final int puerto_limpiadora = 5000;
    ...
    private void conectarAlServidor() {
        try {
            socket = new Socket(host_limpiadora, puerto_limpiadora);
